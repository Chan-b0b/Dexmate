...
distribution plus the unsaturated $\chat_{\mathrm{fmag}}$ channel. An uncalibrated transplant
onto a different architecture fails outright (Sec.~\ref{sec:discussion}).} Two properties are essential. \emph{Computed, not
...
first-contact state are transplanted into pre-contact descent frames. This
...
each route. \todo{verify exact transplanted dims (wrench+seal vs full state) in
...
the frozen policy in a closed loop: commanded descent advances a virtual
