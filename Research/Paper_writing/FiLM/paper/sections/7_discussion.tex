...
conditioning to $\pi_{0.5}$ via action-expert injection with uncalibrated offsets produces the
...
force pathway. A dedicated pathway plus counterfactual data is necessary but not sufficient: injection
site and calibration must be re-engineered per architecture (consistent with the calibration
sensitivity observed within SmolVLA). \decide{keep this paragraph's
