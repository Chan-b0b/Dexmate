...
--------
  ...
  manipulation_bridge/manipulation_manager.py
    ...
    Manipulation (VegaTask{1,2,3,4,5}-020): first Grab on /situation/next_action includes
...
---------------------------------------------------------------
  ...
  VegaTask4-040-Finish   sequential workflow: 041-Place -> 042-Sit -> /manipulation/state success
  VegaTask5-040-Finish   sequential workflow: 041-Place -> 042-Sit -> /manipulation/state success
  ...
  VegaTask4-010-Initialize  workflow: 011-Stand -> 012-Perception -> /manipulation/state success or failed (same as Task1/2/3)
  VegaTask4-020-Manipulation  workflow: 021-Grab -> /manipulation/state success (same as Task1/2/3)
  VegaTask5-010-Initialize  workflow: 011-Stand -> 012-Perception -> /manipulation/state success or failed (same as Task1/2/3/4)
  VegaTask5-020-Manipulation  workflow: 021-Grab -> /manipulation/state success (same as Task1/2/3/4)
...
----------------------
  Expect JSON on SITUATION_PERCEPTION_RESULT_TOPIC with:
    ...
    VegaTask3-012-Perception, VegaTask4-012-Perception, VegaTask5-012-Perception), can_pick, delta, position (delta may use legacy key "offset").
