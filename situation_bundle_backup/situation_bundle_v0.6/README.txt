...
--------
  ...
  manipulation_bridge/manipulation_manager.py
    ...
    Manipulation (VegaTask{1,2,3,4}-020): first Grab on /situation/next_action includes
...
----------------------
  Expect JSON on SITUATION_PERCEPTION_RESULT_TOPIC with:
    ...
    VegaTask3-012-Perception, VegaTask4-012-Perception), can_pick, delta, position (delta may use legacy key "offset").
