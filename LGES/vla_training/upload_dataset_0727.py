#!/usr/bin/env python3
"""Upload the built lges_case_pick_0727 splits to the HF Hub.
...
and already-committed files are skipped.
  ...
  /home/dexmate/miniconda3/bin/python upload_dataset_0727.py
"""
import json
...
SPLITS = ["lges_case_pick_0727", "lges_case_pick_0727_val"]
ORG = "Chanho-Lee"
